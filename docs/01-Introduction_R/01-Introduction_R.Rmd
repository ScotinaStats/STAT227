...
<!--
pagedown::chrome_print("~/Dropbox/Teaching/03-Simmons Courses/MATH227-Intermediate Statistics/Lecture Slides/01-Introduction/01-Introduction.html")
-->
...
- For Windows, click [HERE](https://cran.case.edu/bin/windows/base/R-4.0.2-win.exe).
- For Mac, click [HERE](https://cran.case.edu/bin/macosx/R-4.0.2.pkg).

--

**Installing R Studio**

- For Windows, click [HERE](https://download1.rstudio.org/desktop/windows/RStudio-1.3.1056.exe).
- For Mac, click [HERE](https://download1.rstudio.org/desktop/macos/RStudio-1.3.1056.dmg). 
...
gapminder2007 <- read_csv("~/Dropbox/Teaching/03-Simmons Courses/STAT227-Statistical Design and Analysis [ONLINE]/Data/gapminder2007.csv")
```
