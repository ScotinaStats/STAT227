...
- For Windows, click [HERE](https://cran.revolutionanalytics.com/bin/windows/base/R-4.0.2-win.exe).
- For Mac, click [HERE](https://cran.revolutionanalytics.com/bin/macosx/R-4.0.2.pkg).

--

**Installing R Studio**

- For Windows, click [HERE](https://download1.rstudio.org/desktop/windows/RStudio-1.3.1073.exe).
- For Mac, click [HERE](https://download1.rstudio.org/desktop/macos/RStudio-1.3.1073.dmg). 
