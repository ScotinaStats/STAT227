...
.center[
```{r, echo = FALSE}
knitr::kable(data.frame(Continent = c("EDM", "Latin", "Pop", "R&B", "Rap", "Rock", "TOTAL"), 
...
The sum of squares *within* continents (558.4) is a composite measure of the variability in the values within each continent. 
