...
Using `histogram()` in the `mosaic` package, construct a **histogram** of your 30 `prop_red` values in `virtual_prop_red`. 
- Make sure you add `type = "count"` so the *y*-axis gives a **count**. 
